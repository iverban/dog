  ...
  return (
    <div className='absolute top-1/2 left-full flex w-fit -translate-y-1/2 items-center gap-5'>
      <div className='relative'>
        <div className='h-px w-[6.5rem] bg-purple-400' />
        <div className='absolute top-1/2 right-0 size-1 -translate-y-1/2 rotate-45 bg-purple-400' />
      </div>
...
export function UserDetails() {
  ...
  return (
    <div className='ring-muted max-w-md rounded-xl p-8 shadow ring'>
      ...
      <div className='bg-secondary divide-y rounded-lg px-4 py-1'>
